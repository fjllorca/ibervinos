...
<html lang="es">
    ...
    <body>
        <h3><a href="viewinsert.php">Insertar nuevo Vino</a></h3>
        <table border="1">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class='borrar' href='phpdelete.php?idvino=<?php echo $vino->getIdvino(); ?>'>Borrar</a>
                        <a href='viewedit.php?idvino=<?php echo $vino->getIdvino(); ?>'>Editar</a><br/>
                    </td>
